 ...
 */
@Data
@ApiModel(value = "考核表",description = "")
@TableName("examine")
public class Examine extends BaseEntity {
    ...
    /** 状态( 0 未开始  1 考核中  2 结束 ) */
    @ApiModelProperty(name = "状态( 0 待开始  1 考核中  2 结束->直接到开始公示  3  结束公示 )",notes = "")
    ...
    /** 开始公示日期 */
    @ApiModelProperty(name = "开始公示日期",notes = "")
    private String startPublicityDate;
    /** 结束公示日期 */
