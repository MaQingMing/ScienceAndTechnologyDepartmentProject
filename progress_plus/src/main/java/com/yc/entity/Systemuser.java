...
public class Systemuser extends BaseEntity implements UserDetails{
    ...
    /** 可换钱的分数 */
    @ApiModelProperty(name = "可换钱的分数",notes = "")
    private Double scoreBalance ;
    /** 不可换钱的分数 */
    @ApiModelProperty(name = "不可换钱的分数",notes = "")
    private Double nonScoreBalance ;
    /** 考核完后 (可换钱的分数+不可换钱的分数) 不够扣 需要记录差多少分 */
    @ApiModelProperty(name = "需要记录差多少分",notes = "")
